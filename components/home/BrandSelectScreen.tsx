      ...
      <div className="space-y-5">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <div className="mt-2 text-2xl font-extrabold">CMO 起手环境</div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {brandCards.map((b) => (
              <Link
                ...
                className="block"
              >
                <div className="border border-[#00ffaa]/15 bg-[#06080d]/40 p-4 shadow-pixel transition hover:brightness-110">
